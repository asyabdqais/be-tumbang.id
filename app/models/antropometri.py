...
class Antropometri(Base):
    ...
    berat_badan = Column(Float)       # in kg
    tinggi_badan = Column(Float)      # in cm

    # Data Skrining Tambahan (Langkah 2)
    ...
    asi_eksklusif = Column(Boolean, nullable=True)        # True = Ya, False = Tidak

    # Calculated values (otomatis dari Z-Score Service)
